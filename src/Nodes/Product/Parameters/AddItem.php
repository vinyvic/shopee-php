...
class AttributeList extends RequestParameters
{
    /**
    ...
    /**
     * @param int $attributeValueList
     * @return $this
     */
    public function setAttributeValueList(array $attributeValueList)
    {
        $this->parameters['attribute_value_list'] = $attributeValueList;
...
class AttributeValueList
{
    ...
    /**
     * @param int       $valueId            Value ID. In the following cases, the value id needs to be uploaded as 0, and original_value_name is mandatory, needs to be filled in customized value. (1) AttributeInputType is TEXT_FILED; (2) AttributeInputType is COMBO_BOX or MULTIPLE_SELECT_COMBO_BOX, and the seller want to fill in a customized value.
     * @param string    $originalValueName  Value name. original_value_name from product.get_attributes api. If value id=0, this field is required. If AttributeType is DATE_TYPE or TIMESTAMP_TYPE, you can upload timestamp(string type) as the original_value_name.
     * @param string    $valueUnit          Unit of attribute value (quantitative attribute only).
     * @return array    attribute_value_list
     */
     ...
     * @return $this
     */
    public function addAttributeValue(int $valueId, string $originalValueName = null, string $valueUnit = null)
    {
        // Required
        ...
        if ($originalValueName != null) {
            $attributeValue["original_value_name"] = $originalValueName;
        }

        if ($valueUnit != null) {
            $attributeValue["value_unit"] = $valueUnit;
        }
